...
export const API_SETTINGS_ENDPOINTS = {
  GET_LIST: `${API_BASE}${API_ENDPOINT_CONFIG_SUBPATH}/GetList`,
  UPDATE: `${API_BASE}${API_ENDPOINT_CONFIG_SUBPATH}/Update`,
  BULK_UPDATE: `${API_BASE}${API_ENDPOINT_CONFIG_SUBPATH}/BulkUpdate`,
  REMOVE: `${API_BASE}${API_ENDPOINT_CONFIG_SUBPATH}/Remove`,
} as const;
