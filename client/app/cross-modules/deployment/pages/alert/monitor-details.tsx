...
import AddSingleMonitor from "@blocks-deployment/components/add-repo/add-repo";
import { Separator } from "@/components/ui-kits/separator/separator";
import { BREADCRUMB_CUSTOM_TITLES } from "@/constants/breadcrumb-custom-title";
import { ArrowLeft, Settings } from "lucide-react";
import { Skeleton } from "@/components/ui-kits/skeleton/skeleton";
import AlertAction from "@blocks-deployment/components/add-repo/alert-action";
import { IMonitorSummary } from "@blocks-deployment/models/alerts";
import MonitorCard from "@blocks-deployment/components/add-repo/monitor-card";
import NotificationModal from "@blocks-deployment/components/add-repo/notification-modal";
import {
  LoadingListSkelton,
  MonitorCardSkeleton,
  ResponseSkeletonLoader,
} from "@blocks-deployment/components/add-repo/skeleton-loader-card";
