 ...
 */
export const getStepStatus = (eventType: DeploymentEventType): IBuildStep["status"] => {
  switch (eventType) {
...
export const getTimeDifference = (start: string | number | Date, end: string | number | Date) => {
