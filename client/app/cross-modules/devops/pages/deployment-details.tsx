...
import { useGetCardProjectAndBranch } from "@blocks-devops/hooks/github-info";
...
import DeploymentLogsTab from "@blocks-devops/components/deployment-details/tabs/deployment-logs-tab";
import SASTTab from "@blocks-devops/components/deployment-details/tabs/sast-tab";
import SCATab from "@blocks-devops/components/deployment-details/tabs/sca-tab";
// import DASTTab from "@blocks-devops/components/deployment-details/tabs/dast-tab";
import { DeploymentEventGroup, DeploymentEventType } from "@blocks-devops/models/live-logs";
import ComingSoonTab from "@blocks-devops/components/deployment-details/tabs/coming-soon";
import { IHttpError } from "@blocks-devops/models/github-info";
...
const DeploymentDetails = () => {
  ...
  const { data: apiResponse, isSuccess, isError, error, isLoading, refetch } = queryResult;
        ...
        <div className="flex w-full flex-col items-start gap-4">
          <div className="flex w-full items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl font-bold text-high-emphasis">{buildIdStr}</h1>
            </div>
          </div>
            ...
            <nav className="flex rounded-lg bg-blocks-primary-shades-300 p-1">
              {tabs.map((tab) => (
                <button
                  ...
                  className={`mx-0.5 rounded-md px-4 py-2 text-sm font-medium transition-all duration-200 ${activeTab === tab.id
