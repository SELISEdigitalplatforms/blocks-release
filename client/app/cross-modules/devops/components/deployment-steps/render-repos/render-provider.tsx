import { providers } from "@blocks-devops/models/git-dummy";
...
import {
  ...
  authenticateWithAws,
} from "@blocks-devops/services/providers.service";
import { iconMap } from "@blocks-devops/models/github-info";
...
const ProviderButtons = ({ destination, onClose, extraState, closeOnProviderSelect }: ProviderButtonsProps) => {
  ...
  if (!destination || destination === "") {
    localStorage.setItem("destination", "/devops/configure");
    destination = "/devops/configure";
  } else {
