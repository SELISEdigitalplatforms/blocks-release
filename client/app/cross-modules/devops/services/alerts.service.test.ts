...
describe("AlertsService", () => {
  ...
  describe("addSingleMonitor", () => {
    it("should call correct endpoint with payload", async () => {
      const mockResponse = { ...mockSuccessResponse, data: mockAlert, statusCode: 200 };
      ...
      expect(http.post).toHaveBeenCalledWith(ALERT_ENDPOINTS.SAVE_MONITOR, payload);
  ...
  describe("deleteSingleMonitor", () => {
    it("should call correct endpoint with itemId", async () => {
      const mockResponse = { ...mockDeleteSuccessResponse, data: null, statusCode: 200 };
  ...
  describe("updateSingleMonitor", () => {
    it("should call correct endpoint with payload", async () => {
      ...
      expect(http.post).toHaveBeenCalledWith(ALERT_ENDPOINTS.UPDATE_MONITOR, payload);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("getMonitorListById", () => {
    it("should call correct endpoint with projectKey and repoId", async () => {
      ...
      const result = await alertsService.getMonitorListById(TEST_PROJECT_KEY, MOCK_REPO_ID);
  ...
  describe("isExternalServiceConfigured", () => {
    it("should call correct endpoint with externalServiceId", async () => {
      ...
      const result = await alertsService.isExternalServiceConfigured(externalServiceId);
  ...
  describe("getHealthMonitorList", () => {
    it("should call correct endpoint with params", async () => {
      ...
      const pageNumber = 1;
      const pageSize = 20;
      const result = await alertsService.getHealthMonitorList(TEST_PROJECT_KEY, monitorSourceType, pageNumber, pageSize);
  ...
  describe("getAllMonitorIncidentList", () => {
    it("should call correct endpoint with monitorId and pagination", async () => {
      ...
      const pageNumber = 2;
      const pageSize = 50;
      const result = await alertsService.getAllMonitorIncidentList(MOCK_MONITOR_ID, pageNumber, pageSize);
  ...
  describe("GetMonitorResponseTime", () => {
    it("should call correct endpoint with payload", async () => {
      ...
      const payload = { monitorId: MOCK_MONITOR_ID, startTime: "2023-01-01", endTime: "2023-01-02" };
  ...
  describe("saveHealth", () => {
    it("should call correct endpoint with payload", async () => {
      ...
      expect(http.post).toHaveBeenCalledWith(ALERT_ENDPOINTS.SAVE_HEALTH, payload);
      expect(result).toEqual(mockResponse);
    });
  });
  ...
  describe("updateHealth", () => {
    it("should call correct endpoint with payload", async () => {
      ...
      expect(http.post).toHaveBeenCalledWith(ALERT_ENDPOINTS.UPDATE_HEALTH, payload);
      expect(result).toEqual(mockResponse);
    });
  });
