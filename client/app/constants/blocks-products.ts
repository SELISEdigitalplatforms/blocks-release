...
export const BLOCKS_PRODUCTS: BlocksProduct[] = [
  ...
  },
  {
    ...
    keywords: ["multilingual", "contextual", "automated", "instant", "scalable"],
    shortDescription:
  ...
  },
  {
    ...
    keywords: ["queryable", "structured", "validated", "versioned", "accessible"],
    shortDescription:
  ...
  },
  {
    ...
    keywords: ["intelligent", "generative", "contextual", "instant", "adaptive"],
    shortDescription:
  ...
  },
  {
    ...
    keywords: ["reasoning", "autonomous", "embeddable", "intelligent", "adaptive"],
    shortDescription:
