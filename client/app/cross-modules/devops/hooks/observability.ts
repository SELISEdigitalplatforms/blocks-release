...
export const useGetSCALibraryData = (buildId: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const result = await observabilityService.SCAData(buildId, projectKey, "libraries");
      return result;
    },
    enabled: !!buildId,
    retry: 2,
...
export const useGetSCADContainerData = (buildId: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const result = await observabilityService.SCAData(buildId, projectKey, "container");
      return result;
    },
    enabled: !!buildId,
    retry: 2,
...
export const useSCARedirectLink = (buildId: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const result = await observabilityService.SCARedirect(buildId, projectKey);
      return result;
    },
    enabled: !!buildId,
    retry: 2,
...
export const useSASTRedirectLink = (buildId: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const result = await observabilityService.SASTRedirect(buildId, projectKey);
      return result;
    },
    enabled: !!buildId,
    retry: 2,
